...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mircoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mircoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mircoin transaction") + "\n" +
              "  mircoin-tx [options] -create [commands]   " + _("Create hex-encoded mircoin transaction") + "\n" +
              "\n";
