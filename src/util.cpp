...
const char * const BITCOIN_CONF_FILENAME = "mircoin.conf";
const char * const BITCOIN_PID_FILENAME = "mircoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Mircoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Mircoin";
#else
    // Unix
    return pathRet / ".mircoin";
#endif
#endif
}
